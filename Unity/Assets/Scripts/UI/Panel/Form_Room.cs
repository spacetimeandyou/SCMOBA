...
class Form_Room : UIBase
{
    ...
    protected override void OnActive()
    {
        ...
        EventCenter.Instance.AddListener("MsgStartBattle", OnMsgStartBattle);
        //发送查询
    ...
    protected override void OnDeActive()
    {
        ...
        EventCenter.Instance.RemoveListener("MsgStartBattle", OnMsgStartBattle);
    }
    ...
    //收到开战返回
    public void OnMsgStartBattle(object sender, EventArgs args)
    {
        MsgStartBattle msg = (MsgStartBattle)((MsgEventArgs)args).msgBase;
        //开战
        if (msg.result == 0)
        {
            UIManager.Instance.DeActiveUI<Form_Room>(UIPanel.Form_Room);
